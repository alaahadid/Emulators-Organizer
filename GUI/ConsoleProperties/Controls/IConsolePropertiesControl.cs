...
{
    public partial class IConsolePropertiesControl : UserControl
    {
        public IConsolePropertiesControl()
        {
            InitializeComponent();
    ...
    public class ConsolePropertiesControlComparer : IComparer<IConsolePropertiesControl>
    {
        bool AtoZ;
        public ConsolePropertiesControlComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(IConsolePropertiesControl x, IConsolePropertiesControl y)
        {
            if (AtoZ)
