...
{
    public partial class ConsolesGroupPropertiesIconAndBackground : IConsolesGroupPropertiesControl
    {
        public ConsolesGroupPropertiesIconAndBackground()
        {
            InitializeComponent();
        }
        ...
        public override string Description
        {
            get
            {
                return ls["ConsolesGroupPropertiesDescription_Icon"];
            }
        }
        ...
        {
            pictureBox_icon.Image = profileManager.Profile.ConsoleGroups[consolesGroupID].Icon;
        }
        public override void SaveSettings()
        {
            profileManager.Profile.ConsoleGroups[consolesGroupID].Icon = pictureBox_icon.Image;
        }
