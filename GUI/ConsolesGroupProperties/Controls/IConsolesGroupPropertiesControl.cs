...
{
    public partial class IConsolesGroupPropertiesControl : UserControl
    {
        public IConsolesGroupPropertiesControl()
        {
            InitializeComponent();
        ...
        protected string consolesGroupID;
        protected ProfileManager profileManager;
        protected LanguageResourcesService ls;

        public string ConsolesGroupID
        { get { return consolesGroupID; } set { consolesGroupID = value; } }
    ...
    public class ConsolesGroupPropertiesControlComparer : IComparer<IConsolesGroupPropertiesControl>
    {
        bool AtoZ;
        public ConsolesGroupPropertiesControlComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(IConsolesGroupPropertiesControl x, IConsolesGroupPropertiesControl y)
        {
            if (AtoZ)
