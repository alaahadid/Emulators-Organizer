...
{
    public partial class IEmulatorPropertiesControl : UserControl
    {
        public IEmulatorPropertiesControl()
        {
            InitializeComponent();
        ...
        protected string emulatorID;
        protected ProfileManager profileManager;
        protected LanguageResourcesService ls;

        public string EmulatorID
        { get { return emulatorID; } set { emulatorID = value; } }
    ...
    public class EmulatorPropertiesControlComparer : IComparer<IEmulatorPropertiesControl>
    {
        bool AtoZ;
        public EmulatorPropertiesControlComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(IEmulatorPropertiesControl x, IEmulatorPropertiesControl y)
        {
            if (AtoZ)
