...
{
    public partial class PlaylistProprtiesStyle : IPlaylistPropertiesControl
    {
        public PlaylistProprtiesStyle()
        {
            InitializeComponent();
        }
        ...
        public override string Description
        {
            get
            {
                return ls["PlaylistPropertiesDescription_Style"];
            }
        }
        public override void LoadSettings()
        {
            base.LoadSettings();
            style = profileManager.Profile.Playlists[base.playlistID].Style.Clone();
        ...
        public override void SaveSettings()
        {
            ...
            profileManager.Profile.Playlists[base.playlistID].Style = style.Clone();
        }
