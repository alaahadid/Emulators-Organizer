...
{
    public partial class IPlaylistsGroupPropertiesControl : UserControl
    {
        public IPlaylistsGroupPropertiesControl()
        {
            InitializeComponent();
        ...
        protected string playlistsGroupID;
        protected ProfileManager profileManager;
        protected LanguageResourcesService ls;

        public string PlaylistsGroupID
        { get { return playlistsGroupID; } set { playlistsGroupID = value; } }
    ...
    public class PlaylistsGroupPropertiesControlComparer : IComparer<IPlaylistsGroupPropertiesControl>
    {
        bool AtoZ;
        public PlaylistsGroupPropertiesControlComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(IPlaylistsGroupPropertiesControl x, IPlaylistsGroupPropertiesControl y)
        {
            if (AtoZ)
