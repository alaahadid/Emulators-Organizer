...
{
    public partial class PlaylistsGroupPropertiesIcon : IPlaylistsGroupPropertiesControl
    {
        public PlaylistsGroupPropertiesIcon()
        {
            InitializeComponent();
        }
        ...
        public override string Description
        {
            get
            {
                return ls["PlaylistsGroupPropertiesDescription_Icon"];
            }
        }
        ...
        {
            pictureBox_icon.Image = profileManager.Profile.PlaylistGroups[playlistsGroupID].Icon;
        }
        public override void SaveSettings()
        {
            profileManager.Profile.PlaylistGroups[playlistsGroupID].Icon = pictureBox_icon.Image;
        }
