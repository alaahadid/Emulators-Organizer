...
{
    public partial class PlaylistsGroupPropertiesStyle : IPlaylistsGroupPropertiesControl
    {
        public PlaylistsGroupPropertiesStyle()
        {
            InitializeComponent();
        }
        ...
        public override string Description
        {
            get
            {
                return ls["PlaylistsGroupPropertiesDescription_Style"];
            }
        }
        public override void LoadSettings()
        {
            base.LoadSettings();
            style = profileManager.Profile.PlaylistGroups[base.playlistsGroupID].Style.Clone();
        ...
        public override void SaveSettings()
        {
            ...
            base.SaveSettings();
            profileManager.Profile.PlaylistGroups[base.playlistsGroupID].Style = style.Clone();
        }
