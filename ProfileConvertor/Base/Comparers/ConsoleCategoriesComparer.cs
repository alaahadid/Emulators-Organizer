...
{
    public class ConsoleCategoriesComparer : IComparer<ConsoleCategory>
    {
        bool AtoZ = true;
        public ConsoleCategoriesComparer(bool AtoZ)
        {
            this.AtoZ = AtoZ;
        }
        public int Compare(ConsoleCategory x, ConsoleCategory y)
        {
            if (AtoZ)
