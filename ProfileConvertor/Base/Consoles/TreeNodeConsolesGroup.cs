...
namespace AHD.EO.Base
{
    public class TreeNodeConsolesGroup : EOTreeNode
    {
        ConsolesGroup group;
        /// <summary>
        /// Get or set the consoles group
        /// </summary>
        public ConsolesGroup ConsolesGroup
        { get { return this.group; } set { this.group = value; RefreshText(); RefreshNodes(); } }
        /// <summary>
        ...
        {
            this.Nodes.Clear();
            foreach (Base.Console console in group.Consoles)
            {
                TreeNodeConsole tr = new TreeNodeConsole();
                tr.Console = console;
                tr.RefreshNodes();
                this.Nodes.Add(tr);
            }
