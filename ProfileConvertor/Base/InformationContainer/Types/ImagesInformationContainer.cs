...
namespace AHD.EO.Base
{
    ...
    public class ImagesInformationContainer : FilesInFolderInformationContainer
    {
        public ImagesInformationContainer()
            : base()
        { }
        public ImagesInformationContainer(string name)
            : base(name)
        {
