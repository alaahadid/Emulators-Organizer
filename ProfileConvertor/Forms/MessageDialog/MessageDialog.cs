...
namespace AHD.Forms
{
    ...
    {
        static ResourceManager resources = new ResourceManager("AHD.Forms.LanguageResources.Resource", Assembly.GetExecutingAssembly());
        #region Normal
        /// <summary>
        /// Show message box
        /// </summary>
            ...
            string OkButtonText, string NoButtonText, string CancelButtonText, string CheckBoxText)
        {
            ...
            frmMessage.label_messegeText.Text = MessageText;
            ...
            MessageDialogResult result = frmMessage.checkBox1.Checked ? MessageDialogResult.Checked : 0;
            switch (windowResult)
            {
        ...
        {
            return ShowMessage(null, MessageText, WindowCaption, MessageButtons, MessageIcon, false,
                resources.GetString("Button_Ok"), resources.GetString("Button_No"), resources.GetString("Button_Cancel"), "");
        }
        /// <summary>
        /// Show message box
        ...
        { return ShowQuestionMessage(null, MessageText, WindowCaption, resources.GetString("Button_Yes"),
